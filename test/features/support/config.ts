...
export const config = {
  ...
  paths: {
    ...
    createIngesterConnection: required('SUT_CREATE_INGESTER_CONNECTION_PATH', '/v1/ingester/connections'),
    listIngesterConnections: required('SUT_LIST_INGESTER_CONNECTIONS_PATH', '/v1/ingester/connections'),
    getIngesterConnection: required('SUT_GET_INGESTER_CONNECTION_PATH', '/v1/ingester/connections/{connectionId}'),
    updateIngesterConnection: required('SUT_UPDATE_INGESTER_CONNECTION_PATH', '/v1/ingester/connections/{connectionId}'),
    deleteIngesterConnection: required('SUT_DELETE_INGESTER_CONNECTION_PATH', '/v1/ingester/connections/{connectionId}'),
    triggerIngesterPoll: required('SUT_TRIGGER_INGESTER_POLL_PATH', '/v1/ingester/poll'),
    getIngesterEgressAudit: required('SUT_GET_INGESTER_EGRESS_AUDIT_PATH', '/v1/ingester/audit/egress'),
    evaluateEligibility: required('SUT_EVALUATE_ELIGIBILITY_PATH', '/v1/eligibility/evaluate'),
